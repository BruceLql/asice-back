...
public class SimpleMailSender extends BaseController {
    ...
    public static void main(String[] args) {
        ...
        mailInfo.setValidate(true);
        mailInfo.setConfig(EmailConfigType.SMTP_OFFICE365.toString());
        mailInfo.setUserName("Mia@sidmann.de");
        mailInfo.setPassword("Puk69322");// 您的邮箱密码
        mailInfo.setFromAddress("Mia@sidmann.de");
        mailInfo.setToAddress("liqilan000@icloud.com");
