...
%>
<!DOCTYPE html>
<html lang="en" id="1530144170456-8288">
	<head>
	<base href="<%=basePath%>">
	<!-- jsp文件头和头部 -->
	...
	<div class="row-fluid">
			...
			<table border='0'>
				<tr>
					...
					<td><input class="span10 date-picker" name="lastLoginEnd" id="lastLoginEnd" value="${pd.lastLoginEnd}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:120px;" placeholder="到期日期"/></td>
