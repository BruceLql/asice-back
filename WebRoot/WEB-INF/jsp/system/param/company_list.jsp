...
%>
<!DOCTYPE html>
<html lang="en" id="1530144384036-2067">
	<head>
  ...
  <div class="row-fluid">
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">客户（公司）</th>
						
						<th class="center">公司下属部门</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.RISK_A_EXT_SYS_CP_NAME}</td>
										
										<td>${var.RISK_A_EXT_SYS_CP_DEP}</td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		$(function() {
			...
			$("[name='lookall']").click(function(){
				 top.jzts();
				 var COMPANY_ID=this.id;
				 var diag = new top.Dialog();
				 diag.Drag=true;
				 diag.Title ="计费类型选择";
				 diag.URL = '<%=basePath%>billing/info.do?COMPANY_ID='+COMPANY_ID;
				 diag.Width = 800;
				 diag.Height = 400;
				 diag.CancelEvent = function(){ //关闭事件
					 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
