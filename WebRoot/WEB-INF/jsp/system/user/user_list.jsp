...
%>
<!DOCTYPE html>
<html lang="en" id="1530144751084-9267">
	<head>
	<base href="<%=basePath%>">
	<!-- jsp文件头和头部 -->
	...
	<div class="row-fluid">
			...
			<table>
				<tr>
					...
					<td><input class="span10 date-picker" name="lastLoginStart" id="lastLoginStart"  value="${pd.lastLoginStart}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:120px;" placeholder="开始日期" title="最近登录开始"/></td>
					<td><input class="span10 date-picker" name="lastLoginEnd" name="lastLoginEnd"  value="${pd.lastLoginEnd}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:120px;" placeholder="结束日期" title="最近登录结束"/></td>
